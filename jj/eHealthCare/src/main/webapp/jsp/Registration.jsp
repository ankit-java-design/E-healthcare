...
<div class="container mt-2"
		...
		<nav style="-bs-breadcrumb-divider: '&gt;';" aria-label="breadcrumb">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="<%=DFViewCtl.WELCOME_CTL%>">Home</a></li>
		...
		<hr>
		<form action="<%=DFViewCtl.REGISTRAION_CTL%>" method="post">
											...
											<div class="form-group">
												<input type="text" class="form-control"
													id="exampleInputEmail1" aria-describedby="emailHelp"
														name="dob" id="datepicker" data-provide="datepicker"
													value="<%=DataUtility.getStringData(bean.getDob())%>"
													placeholder="Enter DOB Here"> <font color="red"><%=ServletUtility.getErrorMessage("dob", request)%></font>
											</div>
<br>
<div class="text-center">
					<input type="submit" class="btn btn-primary" name="operation"
						value="<%=RegistrationCtl.OP_SAVE%>"> &nbsp;&nbsp;<input
						type="submit" class="btn btn-primary" name="operation" value="<%=RegistrationCtl.OP_RESET%>">
</div>
				</div>
				<div class="col-2"></div>
