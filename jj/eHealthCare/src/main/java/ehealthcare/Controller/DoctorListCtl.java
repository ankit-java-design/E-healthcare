...
@WebServlet(name = "DoctorListCtl", urlPatterns = "/doctorlist")
public class DoctorListCtl extends BaseCtl {
	private static final long serialVersionUID = 1L;
	public static final String OP_SEARCH = "search";
	public static final String OP_RESET = "Reset";

	public DoctorListCtl() {
		super();
	}
...
e.printStackTrace();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_RESET.equalsIgnoreCase(op)) {
			ServletUtility.redirect(DFViewCtl.DOCTOR_LIST_CTL, request, response);
			return;
		}
	...
	protected String getView() {
		return DFViewCtl.DOCTOR_LIST_VIEW;
	}
